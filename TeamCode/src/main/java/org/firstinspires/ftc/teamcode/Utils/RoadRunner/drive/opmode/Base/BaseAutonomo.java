...
public class BaseAutonomo extends Base{

    public BaseAutonomo(HardwareMap hardwareMap, DcMotorEx BLMotor, DcMotorEx BRMotor, DcMotorEx FLMotor, DcMotorEx FRMotor) {
        super(hardwareMap, BLMotor, BRMotor, FLMotor, FRMotor);
    }

    public BaseAutonomo(HardwareMap hardwareMap) {
        super(hardwareMap);
    }
    ...
    public void setWheelsPowerVelocity(double drive, double strafe,double twist, double degreesPerSeconds){
